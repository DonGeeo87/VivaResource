...
export const locations: Location[] = [
  {
    ...
    description: 'Serving the Peyton community with essential community resources, food assistance, housing support, and advocacy programs. Our headquarters provides direct services and referrals for families who need them.',
    descriptionEs: 'Sirviendo a la comunidad de Peyton con recursos comunitarios esenciales, asistencia alimentaria, apoyo de vivienda y programas de defensa comunitaria. Nuestra sede central ofrece servicios directos y referencias para las familias que lo necesitan.',
  ...
  },
  {
    ...
    description: 'Providing community resources and services to the Colorado Springs area. Access food assistance, legal aid referrals, healthcare navigation, and educational workshops near you.',
    descriptionEs: 'Recursos comunitarios y servicios para el área de Colorado Springs. Acceda a asistencia alimentaria, referencias legales, navegación de salud y talleres educativos cerca de usted.',
  ...
  },
  {
    ...
    description: 'Supporting the Pueblo community with essential resources including food distribution, housing assistance, healthcare access, and educational programs for local families.',
    descriptionEs: 'Apoyando a la comunidad de Pueblo con recursos esenciales que incluyen distribución de alimentos, asistencia de vivienda, acceso a salud y programas educativos para las familias locales.',
  ...
  },
  {
    ...
    description: 'Bringing community resources and support services to Fountain. Food assistance, family programs, and emergency aid available for local residents.',
    descriptionEs: 'Llevando recursos comunitarios y servicios de apoyo a Fountain. Asistencia alimentaria, programas familiares y ayuda de emergencia disponibles para los residentes locales.',
  ...
  },
  {
    ...
    description: 'County-wide services across El Paso County, Colorado. From rural Peyton to Colorado Springs, we provide community resources, food assistance, and programs for all residents.',
    descriptionEs: 'Servicios en todo el Condado de El Paso, Colorado. Desde Peyton rural hasta Colorado Springs, proporcionamos recursos comunitarios, asistencia alimentaria y programas para todos los residentes.',
