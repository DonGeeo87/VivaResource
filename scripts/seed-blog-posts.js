...
const blogPosts = [
  // ── Article 1: Welcome ──────────────────────────────────────────────
  {
    title: 'Welcome to Viva Resource',
    slug: 'welcome-to-viva-resource',
    excerpt: 'Discover our mission, vision, and commitment to empowering rural communities across Colorado.',
    content: `<p>We are proud to introduce <strong>Viva Resource</strong>, a 501(c)(3) nonprofit organization dedicated to empowering underserved communities across rural Colorado through education, resources, and meaningful connections. Our foundation was born from the belief that every person, regardless of their background or immigration status, deserves access to the tools they need to thrive.</p>
...
<p>As we launch this new chapter, we invite you to explore our website, attend our events, and join us as a volunteer or partner. Together, we can build stronger, more resilient communities across Colorado's Eastern Plains. Welcome to Viva Resource—where hope meets action.</p>`,
    category: 'news',
  ...
  {
    title: 'Bienvenidos a Viva Resource',
    slug: 'welcome-to-viva-resource',
    ...
    content: `<p>Nos enorgullece presentar <strong>Viva Resource</strong>, una organización sin fines de lucro 501(c)(3) dedicada a empoderar a las comunidades inmigrantes y desatendidas de la Colorado rural a través de la educación, los recursos y conexiones significativas. Nuestra fundación nació de la creencia de que cada persona, independientemente de su origen, merece acceso a las herramientas que necesita para prosperar.</p>
...
<p>Al iniciar este nuevo capítulo, te invitamos a explorar nuestro sitio web, asistir a nuestros eventos y unirte a nosotros como voluntario o socio. Juntos, podemos construir comunidades más fuertes y resilientes en las Llanuras Orientales de Colorado. Bienvenidos a Viva Resource—donde la esperanza se convierte en acción.</p>`,
    category: 'news',
    featured_image: 'https://images.unsplash.com/photo-1559027615-cd4628902d42?w=800&h=400&fit=crop',
    author: 'Viva Resource',
    language: 'es',
  ...
  // ── Article 2: Programs Impact ──────────────────────────────────────
  {
    ...
    content: `<p>At Viva Resource, we measure our success not by numbers, but by the lives we touch. Today, we want to share the story of María, a mother of three who came to us seeking guidance on navigating the complex world of social services in rural Colorado.</p>
...
<p>María's story is just one of many. Our programs—including legal aid referrals, educational workshops, job readiness training, and family support services—have helped hundreds of families across Colorado's Eastern Plains take their first steps toward stability and self-sufficiency. Every day, we witness the transformative power of community support, and we are grateful for the volunteers, donors, and partners who make this work possible.</p>`,
  ...
  },
  {
    ...
    content: `<p>En Viva Resource, medimos nuestro éxito no por números, sino por las vidas que tocamos. Hoy queremos compartir la historia de María, una madre de tres hijos que acudió a nosotros buscando orientación para navegar el complejo mundo de los servicios sociales en la Colorado rural.</p>
...
<p>La historia de María es solo una de muchas. Nuestros programas—incluyendo referencias a asistencia legal, talleres educativos, capacitación laboral y servicios de apoyo familiar—han ayudado a cientos de familias en las Llanuras Orientales de Colorado a dar sus primeros pasos hacia la estabilidad y la autosuficiencia. Cada día, somos testigos del poder transformador del apoyo comunitario, y estamos agradecidos con los voluntarios, donantes y socios que hacen posible este trabajo.</p>`,
  ...
  {
    title: 'Resources Available for the Community',
    slug: 'resources-available-for-the-community',
    ...
    content: `<p>Navigating life in a new community can be challenging, especially in rural areas where services may be harder to find. You do not have to do it alone. Viva Resource, along with our network of community partners across Colorado's Eastern Plains, offers a wide range of services designed to support families at every stage of their journey.</p>
...
<p><strong>Legal Services:</strong> Through partnerships with legal aid organizations, we offer information sessions, referral services, and know-your-rights workshops. While we do not provide direct legal representation, we can connect you with trusted professionals who can guide you through housing, work permits, family law, and other legal matters.</p>
...
<p><strong>Food Assistance:</strong> From food bank referrals to nutrition education programs, we work to ensure that no family goes hungry. We partner with local food banks, USDA commodity distribution sites, and community gardens to improve food access in rural areas. Visit our resource center or contact us directly to learn more about what is available in your area. All services are free regardless of immigration status.</p>`,
  ...
  {
    title: 'Recursos Disponibles para la Comunidad',
    slug: 'resources-available-for-the-community',
    ...
    content: `<p>Navegar la vida en una nueva comunidad puede ser un desafío, especialmente en áreas rurales donde los servicios pueden ser más difíciles de encontrar. No tienes que hacerlo solo. Viva Resource, junto con nuestra red de socios comunitarios en las Llanuras Orientales de Colorado, ofrece una amplia gama de servicios diseñados para apoyar a las familias en cada etapa de su camino.</p>
...
<p><strong>Servicios Legales:</strong> A través de alianzas con organizaciones de asistencia legal, ofrecemos sesiones informativas, servicios de referencia y talleres sobre sus derechos. Si bien no proporcionamos representación legal directa, podemos conectarlo con profesionales de confianza que pueden guiarlo en temas de vivienda, permisos de trabajo, derecho familiar y otros asuntos legales.</p>
...
<p>But this is not just about resources—it is about community. Enjoy live music, children's activities, food trucks, and cultural performances that celebrate the rich diversity of our region. Bring your family, bring your friends, and come discover everything our community has to offer. No registration or ID required. We hope to see you there!</p>`,
  ...
  },
  {
    ...
    content: `<p>¡Marquen sus calendarios! Viva Resource se complace en anunciar nuestra próxima <strong>Feria de Recursos Comunitarios 2026</strong>, un evento gratuito diseñado para conectar a las familias con recursos esenciales, organizaciones locales y entre sí. Ya sea que busque información de salud, orientación legal, oportunidades educativas o simplemente desee conectarse con sus vecinos, este evento es para usted.</p>
...
<p>Pero esto no es solo sobre recursos—es sobre comunidad. Disfrute de música en vivo, actividades para niños, camiones de comida y presentaciones culturales que celebran la rica diversidad de nuestra región. Traiga a su familia, traiga a sus amigos, y venga a descubrir todo lo que nuestra comunidad tiene para ofrecer. No se requiere registro ni identificación. ¡Esperamos verle allí!</p>`,
  ...
  // ── Article 5: Volunteer Guide ──────────────────────────────────────
  {
    ...
    content: `<p>Volunteers are the heart and soul of Viva Resource. Without the dedication and generosity of our volunteer team, we simply could not do the work we do. If you are interested in giving back to your community, we would love to have you join us. Here is everything you need to know to get started.</p>
...
<p><strong>Step 4: Start Making a Difference.</strong> After orientation, we will match you with opportunities that align with your skills and schedule. Whether you can commit a few hours a month or several hours a week, your contribution matters. No experience is necessary—we provide training and ongoing support to all our volunteers. Ready to get started? We cannot wait to welcome you to the team!</p>`,
  ...
  },
  {
    ...
    content: `<p>Los voluntarios son el corazón y el alma de Viva Resource. Sin la dedicación y generosidad de nuestro equipo de voluntarios, simplemente no podríamos hacer el trabajo que hacemos. Si estás interesado en retribuir a tu comunidad, nos encantaría que te unas a nosotros. Aquí tienes todo lo que necesitas saber para comenzar.</p>
...
<p>Food security is not just about access—it is about dignity and choice. We believe every family deserves the ability to nourish their loved ones with culturally appropriate, nutritious food. If you or someone you know is facing food insecurity, please reach out to us. Our services are free, confidential, and open to every resident. Together, we can ensure that no one in our community goes hungry.</p>`,
    category: 'impact',
  ...
  },
  {
    ...
    content: `<p>La inseguridad alimentaria sigue siendo uno de los desafíos más urgentes que enfrentan las comunidades rurales de las Llanuras Orientales de Colorado. El transporte limitado, la escasez de opciones de supermercado y las dificultades económicas crean barreras que dejan a muchas familias luchando por poner alimentos nutritivos en la mesa. En Viva Resource, estamos comprometidos a cambiar esa realidad—una familia a la vez.</p>
